...
{
    public partial class VisorDiagnosticos : Form
    {
        public VisorDiagnosticos(ReportDataSource reportDataSource)
        {
            InitializeComponent();
        ...
        private void VisorDiagnosticos_Load(object sender, EventArgs e)
        {
