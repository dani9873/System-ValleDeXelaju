...
{
    public partial class VisorListCamasForm : Form
    {
        public VisorListCamasForm(ReportDataSource reportDataSource)
        {
            InitializeComponent();
        ...
        private void VisorListCamasForm_Load(object sender, EventArgs e)
        {
