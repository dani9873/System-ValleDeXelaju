...
namespace SistemValledeXelaju
{
    public partial class MainForm : Form
    {
        ...
        private void btn_mantenimiento_usuarios_Click(object sender, EventArgs e)
        {
            this.Hide();
            this.Close(); // Cierra la ventana actual
            MantenimientoUsuariosForm mantenimientoUsuariosForm = new MantenimientoUsuariosForm();
            mantenimientoUsuariosForm.ShowDialog();
        }
